<div>
    @if (session()->has('success'))
        <div id="dismiss-alert"
            class="hs-removing:translate-x-5 hs-removing:opacity-0 transition duration-300 bg-teal-50 border border-teal-200 text-sm text-teal-800 rounded-lg p-4 dark:bg-teal-800/10 dark:border-teal-900 dark:text-teal-500 mb-5"
            ...
            <div class="flex">
                ...
                <div class="ps-3 ms-auto">
                    <div class="-mx-1.5 -my-1.5">
                        <button type="button"
                            class="inline-flex bg-teal-50 rounded-lg p-1.5 text-teal-500 hover:bg-teal-100 focus:outline-hidden focus:bg-teal-100 dark:bg-transparent dark:text-teal-600 dark:hover:bg-teal-800/50 dark:focus:bg-teal-800/50"
            ...
            <div class="p-1.5 min-w-full inline-block align-middle">
                <div
                    ...
                    <div class="py-3 px-4 border-b border-gray-200">
                        <div class="relative max-w-xs">
                            ...
                            <input type="text" name="hs-table-search" id="hs-table-search"
                                ...
                                placeholder="Search for items" wire:model.live.debounce.250ms="search">
                            ...
                            @foreach ($customers as $data)
                                <tr>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="ps-6 pe-6 py-3">
                                            <div class="flex items-center gap-x-3">
                                                <div class="grow">
                                                    <span
                                                        class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $loop->iteration }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="ps-6 pe-6 py-3">
                                            <div class="flex items-center gap-x-3">
                                                <div class="grow">
                                                    <span
                                                        class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $data->name }}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td class="h-px w-48 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $data->email }}
                                            </span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $data->phone_number }}
                                            </span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <div class="flex items-center gap-x-3">
                                                <span
                                                    class="text-sm font-semibold text-gray-800 dark:text-neutral-200">{{ $data->address }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                    ...
                    <div
                        ...
                        <div>
                            <p class="text-sm text-gray-600 dark:text-neutral-400">
                                <span class="font-semibold text-gray-800 dark:text-neutral-200">{{ $customers->total() }}</span>
                                results
                            </p>
                        </div>
    ...
    @livewire('components.customer.modalform')
</div>
